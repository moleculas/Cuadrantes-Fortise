...
const GraficoCuadrantes = (props) => {
    ...
    const openLoadingGraficosCuadrantes = useSelector(store => store.variablesGraficos.loadingGraficosCuadrantes);
            ...
            >
                {openLoading ? (
                    ...
                    >
                        ...
                        <Tooltip />
                        {/* <Legend /> */}
                        <Line type="monotone" dataKey="Ingresos" stroke="#3f51b5" activeDot={{ r: 4 }} />
